 ...
 */
enum SFASSETTYPE {SFASSET_DEAD, SFASSET_PLAYER, SFASSET_PROJECTILE, SFASSET_ALIEN_BOSS, SFASSET_ALIEN, SFASSET_ASTEROID, SFASSET_COIN, SFASSET_WALL, SFASSET_LIFE, SFASSET_GAME_OVER, SFASSET_LIFE_GAME_OVER, SFASSET_WIN, /*SFASSET_STAR,*/};
